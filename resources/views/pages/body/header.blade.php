...
<head>
    ...
    <link rel="stylesheet" href="backend/files/bower_components/chartist/css/chartist.css" type="text/css" media="all">
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu"
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="img-radius" src="{{asset('backend/files/assets/images/avatar-4.jpg')}}"
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="img-radius" src="{{asset('backend/files/assets/images/avatar-3.jpg')}}"
                                                    alt="Generic placeholder image">
                                                <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="{{asset('backend/files/assets/images/avatar-4.jpg')}}" class="img-radius"
